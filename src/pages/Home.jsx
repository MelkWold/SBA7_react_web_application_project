...
export default function Home(){
    ...
    return (
        <div className = "homeContainer">
            ...
            <p className = "websiteDescription"> Go ahead and get recipes either by <span style ={{color: "cyan"}}>writing the name of any food</span> or <span style ={{color: "cyan"}}> writing just the first letter</span> of the food name. </p>
